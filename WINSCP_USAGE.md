...
|                           |                           |
|  C:\Users\you\Documents   |  /home/youruser            |
|                           |                           |
|  file1.txt                |  .bashrc                  |
|  file2.sql                |  .claude/                 |
|  notes/                   |  projects/                |
...
When you first connect, WinSCP drops you into the home directory (`/home/youruser`). To navigate to the project directory:

1. Click in the **path bar** at the top of the remote (right) panel. It shows something like `/home/youruser`.
...
[Login]    Host: 192.0.2.10, Port: 22222, User: youruser -> Login
